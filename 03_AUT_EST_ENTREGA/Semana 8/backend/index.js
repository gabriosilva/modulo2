...
// returns the workExperience list
app.post("/workExperience/add", urlencodedParser, (req, res) => {
  res.statusCode = 200;
  res.setHeader("Access-Control-Allow-Origin", "*");
...
// returns the workExperience list
app.post("/workExperience/update", urlencodedParser, (req, res) => {
  res.statusCode = 200;
  res.setHeader("Access-Control-Allow-Origin", "*");
...
// returns the workExperience list
app.post("/workExperience/delete", urlencodedParser, (req, res) => {
  res.statusCode = 200;
  res.setHeader("Access-Control-Allow-Origin", "*");
...
// returns the workExperience list
app.post("/studyExperience/add", urlencodedParser, (req, res) => {
  res.statusCode = 200;
  res.setHeader("Access-Control-Allow-Origin", "*");
...
// returns the workExperience list
app.post("/studyExperience/update", urlencodedParser, (req, res) => {
  res.statusCode = 200;
  res.setHeader("Access-Control-Allow-Origin", "*");
...
// returns the workExperience list
app.post("/studyExperience/delete", urlencodedParser, (req, res) => {
  res.statusCode = 200;
  res.setHeader("Access-Control-Allow-Origin", "*");
